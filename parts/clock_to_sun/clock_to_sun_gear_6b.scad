  ...
  difference() {
    union() {
      ...
      translate([0, 0, layer_thickness])
        circular_shaft(radius=gears_shaft_radius + spacer_sleeve, length=shaft_length - 2);
      translate([0, 0, (shaft_length - 1) * layer_thickness])
        hex_shaft(circumradius=gears_shaft_radius + spacer_sleeve, stellation_radius=gears_shaft_radius + spacer_sleeve / 3);
    }
